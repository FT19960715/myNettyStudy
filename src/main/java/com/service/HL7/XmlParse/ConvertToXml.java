...
//关闭
    ...
    public static void main(String[] args) {
        ...
        Document document = ConvertToXml.ConvertToXmlObject(myHL7string);
        //获取事件
        String eventName = ConvertToXml.GetText(document, "MSH/MSH.9/MSH.9.3");
...
// DocumentElement.SelectNodes(path);
        ...
        String value = ConvertToXml.GetText(document, "QRD/QRD.9/QRD.9.1",0);
        String value1 = ConvertToXml.GetText(document, "QRD/QRD.9/QRD.9.1",1);
        String value2 = ConvertToXml.GetText(document, "QRD/QRD.9/QRD.9.1");
        System.out.println(value+":"+value1+":"+value2);

        List<Node> list = ConvertToXml.GetTexts(document, "QRD/QRD.9/QRD.9.1");
        for(Node node : list)
        {
            System.out.println(":"+node.getText());
        }
        System.out.println(ConvertToXml.ConvertToXml(myHL7string));
    }
}
