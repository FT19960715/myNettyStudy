package com.service.HL7.dealBase64;
...
public class OurOruR01MessageBuilder {
    ...
    private void CreateObxSegment() throws DataTypeException, IOException {
        ...
        String base64EncodedStringOfPdfReport = _ourBase64Helper.ConvertToBase64String(new File("F:\\Program Files\\hl7\\7edit-setup-2.6.10-x64.exe"));
