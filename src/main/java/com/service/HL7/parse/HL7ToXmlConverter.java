...
public class HL7ToXmlConverter {
    ...
    public static void main(String[] args) {
        String myHL7string="MSH|^~\\&|CR1000||LIS01||20191126160900||ORU^R01|0000000001|P|2.6||||0||UNICODE|||\nPID||000001|01|李四|0001^01||M|||||||||| ||||汉|||||||||20^Y|\nOBR||0001||Y||20191126163300||1|0001^001||Y||20191126163600|0|||||3||20190026163700|||||||||||||||||\nOBX|NM|1|CRP^1|3.4|u/l|0-5|N||F||||20191126164200|1|1||\nOBX|NM|1|CRP^1|3.4|u/l|0-5|N||F||||20191126164200|1|1||";
        //获取事件
        Document document = HL7ToXmlConverter.ConvertToXmlObject(myHL7string);

        //获取MSH字段下的MSH.9也就是第9位,MSH.9.1也就是第9位下的第1个字符串
        String str1= HL7ToXmlConverter.GetText(document, "MSH/MSH.9/MSH.9.1");
        System.out.println(str1);
        //第二种方法和第一种基本一样
        String str2= document.selectSingleNode("HL7Message/MSH/MSH.1").getText();
        String str3= document.selectSingleNode("HL7Message/MSH/MSH.3").getText();
        System.out.println(str2+":"+str3);
        //运用在list上的解析可以添加到ListView
